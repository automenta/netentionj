    ...
    start: function (v) {
        ...
        function addEdge(from, to, style, edgeType) {
            ...
            if ((ees !== undefined) && (eet !== undefined)) {
                ...
                console.log('Vertices missing; not displaying edge: ', from, to, style);
            }
            ...
            renderItems(v, GRAPH_MAX_NODES, function (s, v, xxrr) {
                ...
                for (var i = 0; i < xxrr.length; i++) {
                    ...
                    if ((includeEdges['Graph']) /*&& (x.value) && (x.value.g)*/) {
                        var edges = $N.dgraph.outEdges(x.id);
                        ...
                        for (var j = 0; j < edges.length; j++) {
                            var ei = edges[j].name;
                            var str = ei[3] || 1;
                            addNodeForObject($N.object[ei[0]]);
                            addNodeForObject($N.object[ei[2]]);
                            addEdge(ei[0], ei[2], {
                                label: ei[1],
...
//				}
        ...
        _.each(edgeTypes, function (e) {
            ...
            if (_.contains(defaultEdgeTypes, e)) {
                includeCheck.attr('checked', 'true');
                includeEdges[e] = true;
            }
